...
public class Main {
    ...
    private static void initFeatureList(){
        ...
        featureList.add("发布文章-要求先登录");
        featureList.add("查看文章指定内容");
    ...
    private static void initActionList(){
       actionList.add(new UserRegisterAction());
        ...
        actionList.add(new ArticlePublisAction());
    }
    ...
    private static void showMenu(){
        ...
        for(int i=0; i<featureList.size(); i++){
            System.out.printf("  %3d. %s%n", i+1, featureList.get(i));
        }
